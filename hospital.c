...
void procurarConsultasPorMedico(ListaConsulta *listaC)
{
    int idmedico;
    printf("Digite o ID do medico: ");
    scanf("%d", &idmedico);
...
void procurarConsultasPorPaciente(ListaConsulta *listaC)
{
    int idPaciente;
    printf("Digite o ID do paciente: ");
    scanf("%d", &idPaciente);
    ...
    do
    {
        ...
        case 3:
            do
            {
                ...
                printf("4 - Procurar Consultas por Medico\n");
                printf("5 - Procurar Consultas por Paciente\n");
                printf("6 - Atualizar Consulta\n");
                printf("7 - Voltar\n");
                printf("Digite uma opcao: ");
                ...
                case 3:
                    ...
                    break;
                case 4:
                    procurarConsultasPorMedico(&listaC);
                    break;
                case 5:
                    procurarConsultasPorPaciente(&listaC);
                    break;
                case 6:
